...
// Step 4: Display the total number of records




// Step 2: Execute the SQL query
$sql = "SELECT COUNT(*) as total FROM rental_cars";
$result = mysqli_query($conn, $sql);
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6 ">
                    ...
                    <div class="small-box bg-info ">
                        ...
                        <a href="registered_user.php" class="small-box-footer">More info <i
